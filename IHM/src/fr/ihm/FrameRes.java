...
public class FrameRes extends javax.swing.JFrame{
    ...
    public void panel5OK(Color color){
        ...
        if(!this.jToggleButton1.isSelected()){
            ...
            if(color.equals(new Color(212,175,55))||color.equals(new Color(170,169,173))){
                this.jPanel5.setBackground(new Color(242,242,242));
                JOptionPane.showMessageDialog(rootPane, "Vous ne pouvez pas mettre cette couleur pour cet anneau !");
            }
            else{
    ...
    public void changeRing(java.awt.event.ActionEvent evt){
        ...
        switch (this.jLabel6.getText()){
            case "1" -> {if(result > 9){this.jPanel2.setBackground(new Color(242,242,242));this.ring1=0;JOptionPane.showMessageDialog(rootPane, "Vous ne pouvez pas mettre cette couleur pour cet anneau !");}else{this.jPanel2.setBackground(actualColor);this.ring1=result;}}
            case "2" -> {if(result > 9){this.jPanel3.setBackground(new Color(242,242,242));this.ring2=0;JOptionPane.showMessageDialog(rootPane, "Vous ne pouvez pas mettre cette couleur pour cet anneau !");}else{this.jPanel3.setBackground(actualColor);this.ring2=result;}}
            case "3" -> {panel5OK(IntToColor(result)); if(this.jToggleButton1.isSelected()){this.ring3=result;} else {this.ring3=0;JOptionPane.showMessageDialog(rootPane, "L'anneau n'est pas disponible !");}}
